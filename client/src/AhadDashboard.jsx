...
const AhadPharmacyDashboard = () => {
  ...
  const productsRef = collection(db, "pharmacies", "ahadPharmacy", "products");
  ...
  const handleSubmit = async (e) => {
    ...
    if (editProduct) {
      const productRef = doc(db, "pharmacies", "ahadPharmacy", "products", editProduct.id);
  ...
  const handleDelete = async (id) => {
    await deleteDoc(doc(db, "pharmacies", "ahadPharmacy", "products", id));
  ...
  return (
    <div style={{ display: "flex", height: "100vh", backgroundColor: "#f4f6f8" }}>
      ...
      <div style={sidebarStyle}>
        <h2 style={{ color: "white", textAlign: "center", marginBottom: "30px" }}>Ahad Pharmacy</h2>
...
export default AhadPharmacyDashboard;
